/* "if processing is done with two state vatiables"
...
/* 
 * purpose: boolen to report if the command is a shell control command
 * 
 * return: 0 or 1
 */
...
int do_control_command(char **args) {
	...
	if(strcmp(cmd,"if") == 0) {
		...
		fatal("internal error procssing",cmd,2);
	}
 ...
 * 
 * returns: -1 in interactive mode.Should call in scripts
 * */
